	...
	return function(a) {
		...
		(function(b) {
			...
			function h(a) {
				...
				f.resize(a.width, a.height), d.root.add(f);var g = new e.Group("holderTextGroup", {
					text : a.text,
					align : "center",
					font : a.font,
			...
			function l() {
				for (var a, c = [], d = Object.keys(K.vars.invisibleImages), e = 0, f = d.length; f > e; e++) a = K.vars.invisibleImages[d[e]], E(a) && "img" == a.nodeName.toLowerCase() && (c.push(a),
		...
		function b(a) {
			...
			null == document.readyState && document.addEventListener && (document.addEventListener("DOMContentLoaded", function y() {
				...
				w = [];
			if (g[m] === l) e(b);
			else if (t) g[p](q, c, j), a[p](i, c, j);else {
				g[n](r, c), a[n](k, c);try {
